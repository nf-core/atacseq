...
if (params.keepMito)            summary['Keep Mitochondrial'] = 'Yes'
...
if (params.skipMergeReplicates) summary['Skip Merge Replicates'] = 'Yes'
...
process MergeReplicateBAM {
    ...
    when:
    !params.skipMergeReplicates && replicatesExist
...
process MergeReplicateMACSCallPeak {
    ...
    when:
    !params.skipMergeReplicates && replicatesExist && params.macs_gsize
...
process MergeReplicateConsensusPeakSet {
    ...
    when:
    !params.skipMergeReplicates && replicatesExist && params.macs_gsize && multipleGroups
...
process MergeReplicateConsensusPeakSetDESeq {
    ...
    when:
    !params.skipMergeReplicates && !params.skipDiffAnalysis && replicatesExist && params.macs_gsize && multipleGroups
