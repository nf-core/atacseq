...
- [[#327](https://github.com/nf-core/atacseq/issues/327)]Consistently support .csi indices as alternative to .bai to allow SAMTOOLS_INDEX be used with the "-c" flag
