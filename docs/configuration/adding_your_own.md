# nf-core/atacseq: Configuration for other clusters
...
Nextflow has [excellent integration](https://www.nextflow.io/docs/latest/docker.html) with Docker, and beyond installing the two tools, not much else is required - nextflow will automatically fetch the [nfcore/atacseq](https://hub.docker.com/r/nfcore/atacseq/) image that we have created and is hosted at dockerhub at run time.
...
process.container = "shub://nf-core/atacseq"
```
...
```nextflow
singularity.enabled = true
process.container = "/path/to/nf-core-atacseq.simg"
```
