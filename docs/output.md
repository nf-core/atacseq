...
| `bwa/replicate/macs2/`               | MACS2 peak output and corresponding HOMER peak-to-gene annotation file.                                                                                                                                                                                                     |
| `bwa/replicate/macs2/qc/`            | PDF file containing QC plots including fold-change distribution and peak percentage across gene features. Files containing [`FRiP score`](https://genome.cshlp.org/content/22/9/1813.full.pdf+html) and peak counts are also generated for integration with MultiQC report. |
| `bwa/replicate/macs2/merged/`        | Consensus peak-set across all samples.                                                                                                                                                                                                                                      |
| `bwa/replicate/macs2/merged/deseq2/` | Differential binding analysis, PCA and clustering using reads quantified at the replicate-level for the merged peak set.                                                                                                                                                    |  
